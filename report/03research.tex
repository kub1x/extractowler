...
Jena Sesame library\cite[jena] for handling ontological data and JSOUP library for
accessing webpages and addressing elements. As a scenario crOWLer accepts Java
{\tt .class} files containing a implementation of {\tt ConfigurationFactory}
class. This configuration specifies all the information needed for crawling
process: 
