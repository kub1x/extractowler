...
\def\ctustyleversion{beta(o) Nov.2013}
...
\def\prepbox#1{\setbox0=\vsplit #1to0pt}
...
\def\printchap#1{\vfil\break \vglue1cm
...
\def\onesideprinting{\def\printheadline{\locc\tenssi\thefontsize[10]
   ...
   \def\nextoddpage{\vfil\break}\shiftoffset=0pt
}
\def\ignoretospace#1\ {}
...
\def\printapp#1{\vfil\break \vglue1cm
