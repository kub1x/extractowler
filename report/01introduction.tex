...
%In future they are going even beyond that and suggest ``predictive search''
...
%When coming to the automated crawling, we are mostly interested in improving
...
%There have been several attempts in the automatic data annotation. In
...
%As an example, on a webpage of a music band this would find \urlnote{
...
%making it even harder to automatically reason on pages content if it can not be
%distinguished and potentially left aside. We have mentioned few, both potential
